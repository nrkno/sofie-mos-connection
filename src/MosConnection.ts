...
export default class MosConnection {
  ...
  constructor (conf: ConnectionConfig) {
    ...
    this._upperSocket = new MosSocketServer(this._conf.ncs.portUpper, 'Upper')
    this._querySocket = new MosSocketServer(this._conf.ncs.portQuery, 'Query')
    ...
    if (this._conf.ncsBuddy !== undefined) {
      ...
      this._upperBuddySocket = new MosSocketServer(this._conf.ncsBuddy.portUpper, 'Upper')
      this._queryBuddySocket = new MosSocketServer(this._conf.ncsBuddy.portQuery, 'Query')
    }
