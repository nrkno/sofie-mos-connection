import TimeString from '../dataTypes/mosTime'
...
export interface IListMachInfo {
  ...
  DOM: TimeString       // Date of Manufacture.
  ...
  time: TimeString       // Time: Time object changed status. Format is YYYY-MM-DD'T'hh:mm:ss[,ddd]['Z']
  opTime?: TimeString       // Operational Time: date and time of last machine start. Format is YYYY-MM-DD'T'hh:mm:ss[,ddd]['Z']
